...
<body>
	...
	<main>
		<form method="post" action="/create-new-fan">
			...
			<div>
				<label>Bairro: </label> <input type="text" name="bairro" value="" />
			</div>
			<div>
				<label>Cidade: </label> <input type="text" name="cidade" value="" />
			</div>
			<div>
			...
			<div>
				<label>Ativo: </label> <input type="text" name="ativo" value="" />
			</div>
